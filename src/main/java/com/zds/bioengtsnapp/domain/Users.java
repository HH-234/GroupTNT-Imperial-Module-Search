...
public class Users {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getDiscoveryUrlId() == null ? other.getDiscoveryUrlId() == null : this.getDiscoveryUrlId().equals(other.getDiscoveryUrlId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getDiscoveryUrlId() == null) ? 0 : getDiscoveryUrlId().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", discoveryUrlId=").append(discoveryUrlId);
